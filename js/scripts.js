...
telInputBooking.addEventListener("input",() => {
  if (!rightTelSymbols.test(telInputBooking.value)) {
    telInputBooking.setCustomValidity("введите действующий телефон в формате +774377634574, 84848434343 или 454545");
...
telInputContacts.addEventListener("input",() => {
  if (!rightTelSymbols.test(telInputContacts.value)) {
    telInputContacts.setCustomValidity("введите действующий телефон в формате +774377634574, 84848434343 или 454545");
